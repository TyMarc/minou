...
public class MinouUploadFileProgressListener implements ProgressListener {
	private String channelNamespace;
	private Message message;
	
	public MinouUploadFileProgressListener(final Message message, final String channelNamespace){
