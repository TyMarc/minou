...
public class MinouDownloadPictureProgressListener extends MinouDownloadProgressListener {
	private Message message;
	
	public MinouDownloadPictureProgressListener(final Message message){
